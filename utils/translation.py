...
def translate_file(df: pd.DataFrame, file_path: str):
    ...
    output_path = change_suffix_in_path(file_path, "translation")
...
async def process_translate(df: pd.DataFrame = None, file_path: str = None, email: str = None, task_id: str = None):
    ...
    await process_sentiment(new_df, output_path, email, task_id) 